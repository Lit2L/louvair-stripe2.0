    ...
    <section className='container max-w-3xl py-2'>
      <div className='mb-14 space-y-6 text-center'>
        ...
        <p className='text-md text-balance text-muted-foreground'>
          Explore our comprehensive FAQ to find quick answers to common inquiries. If you need
          further assistance, don&apos;t hesitate to contact us for personalized help.
        </p>
      </div>
