...
const tiers = [
  {
    ...
    id: 'pro-plan',
    href: '#',
    price: { monthly: '$110', annually: '$1320' },
    description:
      'Subscribing to the Pro Plan will give you access to all of our world class services.',
    features: [
      'unlimited monthly refills',
      'Commercial grade Air Diffuser',
      'Manage account settings, payments, and more...'
    ],
    mostPopular: false
  }
]
...
export default function SubscriptionDialog(
  ...
  async function handleCheckout() {
    try {
      const lineItems = [
        {
          price: env.NEXT_PUBLIC_STRIPE_PRO_PLAN_PRICE_ID as string,
          quantity: 1
        }
      ]
