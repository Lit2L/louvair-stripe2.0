	...
	return (
		<footer className='mx-auto max-w-[1920px] px-6 pt-6 bg-zinc-900'>
			<div className='grid grid-cols-1 gap-8 py-12 text-white transition-colors duration-150 border-b lg:grid-cols-12 border-zinc-600 bg-zinc-900'>
				...
				<div className='col-span-1 lg:col-span-2'>
					<ul className='flex flex-col flex-initial md:flex-1'>
						<li className='py-3 md:py-0 md:pb-4'>
							<Link href='/' className='text-white transition duration-150 ease-in-out hover:text-zinc-200'>
								Home
							</Link>
						</li>
						<li className='py-3 md:py-0 md:pb-4'>
				...
				<div className='col-span-1 lg:col-span-2'>
					<ul className='flex flex-col flex-initial md:flex-1'>
						...
						<li className='py-3 md:py-0 md:pb-4'>
							<span className='text-white transition duration-150 ease-in-out hover:text-zinc-200'>Privacy Policy</span>
						</li>
						<li className='py-3 md:py-0 md:pb-4'>
							<span className='text-white transition duration-150 ease-in-out hover:text-zinc-200'>Terms of Use</span>
						</li>
					</ul>
				</div>
			</div>
			<div className='flex flex-col items-center justify-between py-12 space-y-4 md:flex-row bg-zinc-900'>
				<div>
					<span className='text-xs'>&copy; {new Date().getFullYear()} Louvair, Inc. All rights reserved.</span>
				</div>
				<div className='flex items-center'>
					<span className='text-white text-xs px-3'>Crafted by</span>
					<a href='https://vercel.com' aria-label='Logo Link'>
						<Image src={Louvair} height={20} width={20} alt='Vercel.com Logo' className='shadow-xl ' />
					</a>
				</div>
			</div>
		</footer>
