	...
	return (
		<section className='column content-width overflow-auto' id='work-section'>
			<div className='anim justify-end flex w-full'>
				<h1 className='text-5xl font-bold' ref={heading}>
					Playtime
				</h1>
			</div>
			<div className='row'>
				<div id='block-0' className='block px-3' onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
					<Image src='/work/greenyellow.jpeg' height='3113' width='500' alt='Ottografie' loading='lazy' />
					<video
						playsInline={true}
						loop={true}
						muted={true}
				...
				<div className='column' id='work-right-section'>
					...
					>
						<Image alt='image play' src='/work/black.jpeg' height='3113' width='500' />
						<video
							playsInline={true}
							loop={true}
							muted={true}
			...
			<div className='row'>
				<div
					...
					onMouseLeave={handleMouseLeave}
				>
					<Image src='/work/blue.jpeg' alt='play image' height={600} width={300} />
					<video
						playsInline={true}
						loop={true}
						muted={true}
				...
				<div id='block-2' className='block' onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
					<Image alt='work image' src='/work/grey.jpeg' fill />
					<video
						playsInline={true}
						loop={true}
						muted={true}
